...
let AuthController = class AuthController {
    ...
    async telegramLogin(telegramAuthDto, res) {
    ...
    async telegramWebLogin(webLoginDto, res) {
...
__decorate([
    (0, throttler_1.Throttle)({ default: { limit: 20, ttl: 60 } }),
    (0, common_1.Post)('telegram/web-login'),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Res)({ passthrough: true })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [web_login_dto_1.WebLoginDto, Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "telegramWebLogin", null);
__decorate([
