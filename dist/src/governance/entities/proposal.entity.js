...
], Proposal.prototype, "endsAt", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['ACTIVE', 'PASSED', 'REJECTED', 'EXECUTED'], default: 'ACTIVE' }),
    __metadata("design:type", String)
], Proposal.prototype, "status", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => vote_entity_1.Vote, (vote) => vote.proposal, { cascade: true }),
