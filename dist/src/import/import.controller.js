...
const process_url_dto_1 = require("./dto/process-url.dto");
let ImportController = class ImportController {
    constructor(importService) {
        this.importService = importService;
    }
    processUrl(processUrlDto) {
        return this.importService.processUrl(processUrlDto.url);
    }
};
exports.ImportController = ImportController;
__decorate([
    (0, common_1.Post)('process-url'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [process_url_dto_1.ProcessUrlDto]),
    __metadata("design:returntype", void 0)
], ImportController.prototype, "processUrl", null);
