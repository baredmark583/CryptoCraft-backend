...
let UsersController = class UsersController {
    ...
    update(id, updateUserDto, req) {
        ...
        if (requestingUser.role !== user_entity_1.UserRole.SUPER_ADMIN &&
            requestingUser.userId !== id) {
            throw new common_1.ForbiddenException('You do not have permission to update this user.');
        }
        if (requestingUser.role !== user_entity_1.UserRole.SUPER_ADMIN &&
            updateUserDto.role) {
            throw new common_1.ForbiddenException('You are not allowed to change user roles.');
        }
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], UsersController.prototype, "findOneWithDetails", null);
__decorate([
    (0, common_1.Get)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    __metadata("design:type", Function),
